...
if __name__ == "__main__":
    ...
    second_passage = "The big red cate ate the fat rat hurriedly"
    second_pattern = r'[A-z]{3}'
    second_regex = re.compile(second_pattern)
    print(second_regex.findall(second_passage))
